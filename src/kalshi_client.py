...
BASE_URL = 'https://demo-api.kalshi.co/trade-api/v2' if settings.TEST_MODE else 'https://api.elections.kalshi.com/trade-api/v2'
...
class BaseAPIClient(ABC):
    ...
    def __init__(self, base_url: str, api_key: Optional[str] = None, timeout: int = 30):
        ...
        self.private_key = load_private_key_from_file(settings.get_kalshi_key_path())
